# news-scrape
home work focusing on express, handlebars, mongoose, cheerio, axios
...
Considering we haven’t hit on React yet in class, what can your group start doing?
- create your group
- consider who will do what in the group
- create your project board (Trello, Github projects, etc)
- start breaking things down into tasks
- consider project ideas and pick one
- create a repo
- sketch UI design and flow
- decide which database you want to use (MySQL, Mongo)
- start creating database elements, schema, model, etc
- start creating api endpoints
- test out those api endpoints using Postman
- decide if your app will use authentication (notice it says ‘allow for’ below)
So lots that can be done to give your group a running start. Here are the requirements:
Must use ReactJS.
